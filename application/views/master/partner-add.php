...
<div  class='row'>
    <div class='col-sm-12'>
        <form name='frm' class="form-horizontal" action="<?php echo base_url('partners/partnerAddCon');?>" method="post" id="frm">
            <!-- First Name -->
            <div class="form-group">
                <label for='userid' class="col-sm-2 control-label">លេខកូដដែគូ</label>
                <div class="col-sm-3">
                    <input type="text" id='partnerid' name='partnerid' class="form-control" />
                </div>*
            </div>
            <!-- Last Name -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="tel" id='phone' name='phone' class="form-control" oninput="validatePhone();"/>
                </div>*
            </div>
			 <!-- Address -->
			<div class="form-group">
